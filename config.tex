...
\newminted{haskell}{style=tango, bgcolor=tango-bg,frame=lines,framesep=2mm,samepage=true,fontsize=\tiny}
\newminted{prolog}{frame=lines,framesep=2mm,samepage=true,fontsize=\tiny}